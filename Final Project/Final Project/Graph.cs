...
namespace Graph
{
    ...
    public class Graph
    {
        ...
        private List<FreightTrain> freightTrains;
        ...
        public Graph()
        {
            ...
            freightTrains = new List<FreightTrain>();
        }

        public List<FreightTrain> GetTrains()
        {
